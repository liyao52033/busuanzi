...
func ApiHandler(c *gin.Context) {
	...
	c.JSON(200, gin.H{
		...
		"data": gin.H{
			...
			"today_pv":     counts.TodayPv,
			"today_uv":     counts.TodayUv,
			"yesterday_pv": counts.YesterdayPv,
			"yesterday_uv": counts.YesterdayUv,
			"month_pv":     counts.MonthPv,
			"month_uv":     counts.MonthUv,
		},
	})
}
