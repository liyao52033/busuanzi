fork自[yuwen-busuanzi](https://cnb.cool/yuwen-gueen/yuwen-busuanzi)
...
支持多种运行方式: 源码编译运行, Docker 运行. 详见: [安装方法](https://busuanzi.apifox.cn/doc-5083724)

## 使用方式

支持多种自定义属性, 兼容 pjax 网页, 支持自定义 标签前缀. 详见: [使用文档](https://busuanzi.apifox.cn/doc-5083722)
